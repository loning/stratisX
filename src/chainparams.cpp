...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "Hello Genesis";
        ...
        vout.resize(1);
        vout[0].SetEmpty();
        CTransaction txNew(1, 1496069495, vin, vout, 0);
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime    = 1496069495;
        genesis.nBits    = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce   = 1840204;
        ...
        vSeeds.push_back(CDNSSeedData("hpxt1.dns.hoopox.com", "hpxt1.dns.hoopox.comh"));vSeeds.push_back(CDNSSeedData("hpxt2.dns.hoopox.com", "hpxt2.dns.hoopox.com"));

        //vSeeds.push_back(CDNSSeedData("hpxtplatform.com", "seed.hpxtplatform.com"));
        //vSeeds.push_back(CDNSSeedData("cloudhpxt.com", "seed.cloudhpxt.com"));
...
public:
    CTestNetParams() {
        ...
        genesis.nBits  = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce = 1903340;
        genesis.nTime    = 1493909211;
  
        hashGenesisBlock = genesis.GetHash();
         
        //MineGenesis(genesis);
        assert(hashGenesisBlock == uint256("0x0000dfae2fc22a3459f5a2ef11a27fb6846da90d1e11d7e42e99273293c0926d"));

        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("hpxtplatform.com", "testnode1.hpxtplatform.com"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 65); // hpxt test net start with T
...
public:
    CRegTestParams() {
        ...
        strDataDir = "regtest";
        //MineGenesis(genesis);
        assert(hashGenesisBlock == uint256("0x0000551897fea7621d018a3c1f68902522024e4af41106c4456c25f24b81d193"));
