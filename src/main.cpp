...
static const int64_t GLOBAL_MONEY = /*GLOBAL_MONEY*/ 10000000000;
...
{
    if(pindexBest->nHeight < nStakeMinConfirmations){return GLOBAL_MONEY/nStakeMinConfirmations*COIN +nFees;} else {return nFees;}
}
